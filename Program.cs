...
namespace xr1_2
{
	class MainClass
	{
		public static void Main(string[] args)
		{
			...
			// decimal型
			// 10進数値で格納する変数型 			decimal d = 10; 			Console.WriteLine("d = {0}", d.GetType());
			d = 10.1234m;
			...
			// object型 			object obj; 			obj = 1; // System.Int32 			Console.WriteLine("obj = {0}", obj.GetType()); 			// System.String すべてのクラスの派生元であるため 			// 動的に異なるデータ型を割りあてることが可能 			obj = "ほげ";  			Console.WriteLine("obj = {0}", obj.GetType());
